...
local function resolve_collision(world, e1, e2, mtv)
   ...
   if e2.Velocity then
      ...
      local e1_final_normal_velocity = (e1_normal_velocity * (e1_mass - e2_mass) + 2 * e2_mass * e2_normal_velocity)
         / (e1_mass + e2_mass)
      local e2_final_normal_velocity = (e2_normal_velocity * (e2_mass - e1_mass) + 2 * e1_mass * e1_normal_velocity)
         / (e2_mass + e1_mass)
...
function sys_Collision:process(e, dt)
   ...
   for other in pairs(world.hash:get_objects_in_aabb(get_entity_aabb(e))) do
      if other ~= e then
